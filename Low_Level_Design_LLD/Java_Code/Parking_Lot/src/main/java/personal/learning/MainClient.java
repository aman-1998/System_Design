...
public class MainClient {
	...
	public void run() {
		...
		//ssParkingLot parkingLot = new ParkingLot(2, 2, 2);
		
		System.out.println("Parking Lot: ");
		System.out.println("Available bike spots : " + parkingLot.getAvailableBikeSpots());
		System.out.println("Available car Spots : " + parkingLot.getAvailableCarSpots()); 
		System.out.println("Available truck Spots : " + parkingLot.getAvailableTruckSpots());
